...
#define UE_PROJECT_NAME LeageOfShooter
#define UE_TARGET_NAME LeageOfShooterEditor
#define UE_MODULE_NAME "LeageOfShooter"
...
#define LEAGEOFSHOOTER_API DLLEXPORT
